...
export function Header() {
  return (
    <header className="flex h-24 items-center px-8 bg-white shadow-lg">
      ...
      <button className="w-44 bg-teal-600 hover:bg-teal-500 transition-colors rounded-lg text-white py-2 px-5 text-2xl leading-tight">
        Играть
      </button>
      <button className="ml-auto flex items-center gap-2 text-start text-teal-600 hover:text-teal-500 transition-colors">
        ...
        <div>
          <div className="leading-tight text-lg">Paromovevg</div>
          <div className="text-slate-400 leading-tight text-xs">
            Рейтинг: 1230
          </div>
        </div>
        <svg
